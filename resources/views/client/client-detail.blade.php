  ...
  <button class="btn-circle btn-edit" title="Edit">
    ...
    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
					...
					<div class="social-rights">
						<ul class="list-social"><li><a class="facebook" href="https://www.facebook.com/profile.php?id=61579250014118" title="Like us on Facebook" target="_blank"><img src="http://localhost:8000/client/Facebook_icon.svg" alt="Facebook_icon"></a></li>
						<li><a class="twitter" href="https://x.com/Quickdials" title="Follow us on Twitter" target="_blank"><img src="http://localhost:8000/client/twitter.svg" alt="twitter"></a></li>
						<li><a class="linkedIn" href="https://www.linkedin.com/company/quickdialsoffical" title="Follow us on Linkedin" target="_blank"><img src="http://localhost:8000/client/linkedin.svg" alt="linkedin"></a></li>
						<!-- <li><a class="youTube"  href="" title="Follow us on youTube" target="_blank"><i class="fa fa-youtube-play"></i></a></li> -->
						<li><a class="pinterest" href="https://www.pinterest.com/quickdials12/" title="Follow us on Pinterest" target="_blank"><img src="http://localhost:8000/client/pinterest.svg" alt="pinterest"></a></li>
						<li><a class="instagram" href="https://www.instagram.com/quickdials1/" title="Follow us on Instagram" target="_blank"><img src="http://localhost:8000/client/instagram.svg" alt="instagram"></a></li>                                    
                                </ul>
					</div>
