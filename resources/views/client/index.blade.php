   ...
   <div class="services" >
      <div class="items-list">
         ...
         <div class="items">
            ...
            <span class="title-serv"><a href="{{ url('categories/professional-courses') }}" >Professional Courses</a></span>
         </div>
         ...
         <div class="items"><a href="{{url('child/professional')}}" >
            <img loading="lazy" src="{{asset('img/Professional.png')}}" alt="Professional"></a>
             </div>
