         ...
         <div class="col-md-4 col-sm-4">
            <div class="Email-box clearfix">
               ...
               <div class="Email-info-box">
                  ...
                  <p>
                     <a href="mailto:hr@quickdials.com">hr@quickdials.com</a>							
                  </p>
                  <p>
                     <a href="mailto:admin@quickdials.com">admin@quickdials.com</a>							
                  </p>
                  <p>
                     <a href="mailto:feedback@quickdials.com">feedback@quickdials.com</a>							
                  </p>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row">
             ...
             <div class="col-sm-4 col-md-4">
               ...
               <img loading="lazy" src="<?php echo asset('client/images/payments.png'); ?>" alt="payments" class="img-responsive" style="max-width:240px;">
            </div>
         </div>
      </div>
   </div>
