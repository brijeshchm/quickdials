...
<div class="contact-us">	
 ...
 <div class="support">
    <div>Customer Support India<br><i class="fa fa-envelope-o"></i>    <a href="mailto:info@quickdials.com"> info@quickdials.com</a></div>
...
<div class="container">
        <div class="cnt-ck-scn">
            ...
            <div class="contact-card">
                <div class="icon">
                    <img loading="lazy" src="{{ asset('img/building.png')}}" alt="Building Icon">
                </div>
             
                <h2>Registrad Office:</h2>
                <h4>Quick Dials Internet Pvt Ltd</h4>
                <p>UNIT 101 OXFORD TOWERS, 139/88 HAL OLD AIRPORT RD, H.A.L II Stage, Bangalore North, Bangalore- 560008, Karnataka</p>
                <p><strong>Phone (India):</strong> <a href="tel:917559435943">+91-75-5943-5943</a></p>
                <p><strong>WhatsApp:</strong> <a href="https://wa.me/917559435943">+91-75-5943-5943</a></p>
            </div>

            <!-- Head Branch -->
            <div class="contact-card">
                <div class="icon">
                    <img loading="lazy" src="{{ asset('img/graduation-cap.png')}}" alt="Learning Icon">
                </div>
                <h2>Head Branch</h2>
                    <h4>Quick Dials Internet Pvt Ltd</h4>
                <p>UNIT 101 OXFORD TOWERS, 139/88 HAL OLD AIRPORT RD, H.A.L II Stage, Bangalore North, Bangalore- 560008, Karnataka<br>
            ...
            <div class="contact-card">
                <div class="icon">
                    <img loading="lazy" src="{{ asset('img/globe.png')}}" alt="Globe Icon">
                </div>
                <h3>Branch  -</h3>
                <p></p>
