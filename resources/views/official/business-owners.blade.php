...
<div class="col-sm-7 col-md-7">
    <img loading="lazy" class="img-responsive" src="<?php echo asset('public/client/images/growing.svg'); ?>" style="width: 500px;height: 387px;">
...
<div class="business-clientBlock">
	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-center">
		<img loading="lazy" class="img-responsive" src="<?php echo asset('public/client/images/business/group.png'); ?>" alt="Leads that Convert to Business" />
		<span>Leads that Convert to Business</span>
	</div>
	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-center">
		<img loading="lazy" class="img-responsive" src="<?php echo asset('public/client/images/business/profile.png'); ?>" alt="Ready-to-Share Profile" />
		<span>Ready-to-Share Profile</span>
	</div>
	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-center">
		<img loading="lazy" class="img-responsive" src="<?php echo asset('public/client/images/business/head_phone.png'); ?>" alt="Reliable Customer Support" />
