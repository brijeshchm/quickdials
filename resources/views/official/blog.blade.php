                ...
                <div class="recent-post">
				  ...
				  <div class="recent-single-post">
					...
					<a href="{{url('blog/'.$blogrecent->slug)}}">
					  <img loading="lazy" src="<?php echo (isset($image)?asset($image):"");  ?>" width="96px" height="72px" title="{{$blogrecent->name}}" alt="{{$blogrecent->name}}">
					</a>
                    </div>
                    <div class="pst-content">
                      <p><a href="{{url('blog/'.$blogrecent->slug)}}"><?php echo ucfirst($blogrecent->title);?> .</a></p>
                    </div>
                  </div>
				    @endforeach
				  @endif
              ...
              <div class="single-blog">
                <div class="single-blog-img">
                  <a href="{{url('blog/'.$blog->slug)}}">
					  <img loading="lazy" src="<?php echo (isset($image)?asset($image):"");  ?>" title="{{$blog->name}}" alt="{{$blog->name}}">
				</a>
                </div>
                <div class="blog-meta">
