...
<head>
  ...
  <link href="{{asset('/public/client/images/quickind-quick-large-logo.png')}}" rel="icon">
  <link href="{{asset('/public/client/images/quickind-quick-large-logo.png')}}" rel="apple-touch-icon">
