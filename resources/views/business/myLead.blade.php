...
.lead-left {
    ...
    gap: 15px;
        ...
        <div class="enquiries-section">
            ...
            <div class="tab-content active" id="all">
                ...
                <div class="enquiry-item <?php  if($lead->readLead=='0'){ echo "assignedLeadsClick"; } ?>"  data-assigned_leads= "{{ $lead->assignId }}" data-client_id= "{{ $lead->clientId }}" style="<?php  if(!$lead->readLead){ echo "background:#ddd"; } ?>">
    ...
    <div class="share-menu">
        ...
        <i class="bi bi-eye" aria-hidden="true"></i>
                ...
                <button type="button" class="scrapbutton" data-bs-toggle="modal" data-bs-target="#basicModal_<?php echo $lead->lead_id; ?>">
                    Scrap Lead
                </button>
                <?php  } ?>
                <div class="modal fade" id="basicModal_<?php echo $lead->lead_id; ?>" tabindex="-1">
                    ...
                    <div class="checkbox-container">
                        <label class="checkbox-label">
                            <input type="radio" class="form-check-input" id="gridRadios1" name="scrapLead" data-clientId="<?php if($lead->clientId){ echo $lead->clientId; } ?>" data-leadId="<?php  if($lead->assignId){ echo $lead->assignId; } ?>"  value="1" <?php if(isset($lead->scrapValue) && $lead->scrapValue =='1'){ echo "checked"; } ?>>
                            <span class="checkbox-text"> Student in just exploring & not planing to hire any tutor</span>
                        </label>
                    </div>
                    <div class="checkbox-container">
                        <label class="checkbox-label">
                            <input type="radio" class="form-check-input" id="gridRadios2" name="scrapLead" data-clientId="<?php if($lead->clientId){ echo $lead->clientId; } ?>" data-leadId="<?php  if($lead->assignId){ echo $lead->assignId; } ?>" value="2" <?php if(isset($lead->scrapValue) && $lead->scrapValue =='2'){ echo "checked"; } ?>>
                            <span class="checkbox-text">Enquiry is posted by a tutor, an Institute or a tutor agency</span>
                        </label>
                    </div>
                    <div class="checkbox-container">
                        <label class="checkbox-label">
                            <input type="radio" class="form-check-input" id="gridRadios3" name="scrapLead" data-clientId="<?php if($lead->clientId){ echo $lead->clientId; } ?>" data-leadId="<?php  if($lead->assignId){ echo $lead->assignId; } ?>" value="3" <?php if(isset($lead->scrapValue) && $lead->scrapValue =='3'){ echo "checked"; } ?>>
                            <span class="checkbox-text">Student has selected wrong category</span>
                        </label>
                    </div>
                    <div class="checkbox-container">
                        <label class="checkbox-label">
                            <input type="radio" class="form-check-input" id="gridRadios4" name="scrapLead" data-clientId="<?php if($lead->clientId){ echo $lead->clientId; } ?>" data-leadId="<?php  if($lead->assignId){ echo $lead->assignId; } ?>" value="4" <?php if(isset($lead->scrapValue) && $lead->scrapValue =='4'){ echo "checked"; } ?>>
                            <span class="checkbox-text">Student has select wrong locality</span>
                        </label>
                    </div>
                    <div class="checkbox-container">
                        <label class="checkbox-label">
                            <input type="radio" class="form-check-input" id="gridRadios5" name="scrapLead" data-clientId="<?php if($lead->clientId){ echo $lead->clientId; } ?>" data-leadId="<?php  if($lead->assignId){ echo $lead->assignId; } ?>" value="5" <?php if(isset($lead->scrapValue) && $lead->scrapValue =='5'){ echo "checked"; } ?>>
                    ...
                    <div class="checkbox-container">
                        <label class="checkbox-label">
                            <input type="radio" class="form-check-input" id="gridRadios6" name="scrapLead" data-clientId="<?php if($lead->clientId){ echo $lead->clientId; } ?>" data-leadId="<?php  if($lead->assignId){ echo $lead->assignId; } ?>" value="6" <?php if(isset($lead->scrapValue) && $lead->scrapValue =='6'){ echo "checked"; } ?>>
                            <span class="checkbox-text">Student phone number is either invailid or not reachable or no response </span>
                        </label>
                    </div>
                    <div class="checkbox-container">
                        <label class="checkbox-label">
                            <input type="radio" class="form-check-input" id="gridRadios7" name="scrapLead" data-clientId="<?php if($lead->clientId){ echo $lead->clientId; } ?>" data-leadId="<?php  if($lead->assignId){ echo $lead->assignId; } ?>" value="7" <?php if(isset($lead->scrapValue) && $lead->scrapValue =='7'){ echo "checked"; } ?>>
                            <span class="checkbox-text">Student has already hire tutor for this requirement </span>
                        </label>
                    </div>
                    <div class="checkbox-container">
                        <label class="checkbox-label">
                            <input type="radio" class="form-check-input" id="gridRadios8" name="scrapLead" data-clientId="<?php if($lead->clientId){ echo $lead->clientId; } ?>" data-leadId="<?php  if($lead->assignId){ echo $lead->assignId; } ?>" value="8" <?php if(isset($lead->scrapValue) && $lead->scrapValue =='8'){ echo "checked"; } ?>>
