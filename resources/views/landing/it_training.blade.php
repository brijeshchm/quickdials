            ...
            <div class="tab-pane active" id="engineering">
              <div class="tab-inner">
				...
				<div class="single-awesome-project">
					...
					</div><div class="icon"><i class="fab fa-java"></i></div><p>Are you looking for the best institute to excel basic and advance knowledge in JAVA, you are at the right platform. quickdials provides the best solution for all your training related queries and also help you to find the best institute for getting your training done.</p>
