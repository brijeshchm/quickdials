            ...
            <div class="tab-pane active" id="engineering">
              <div class="tab-inner">
				...
				<div class="single-awesome-project">
					...
					</div><div class="icon"><i class="fa fa-circle"></i></div><p>Are you looking to opt for a translator field or you want to learn Japanese for opening a gateway to explore, we have a solution for it. We at quickdialsprovide the appropriate course according to your needs along with the best institute so you can learn and earn at the best.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 border-line formleftBlock">
				 ...
				 <div class="heading-txt">Why Fill This Form?</div>
                    <ul class="whyChoose">
                        ...
                        <li><span><img loading="lazy" src="<?php echo asset('client/images/icon-1.png'); ?>"></span>UNIT 101 OXFORD TOWERS, 139/88 HAL OLD AIRPORT RD, H.A.L II Stage, Bangalore North, Bangalore- 560008, Karnataka, Email:- info@quickdials.com, Phone:-+91-75-5943-5943, Website:- www.quickdials.com</li>
                    </ul>
                </div>
