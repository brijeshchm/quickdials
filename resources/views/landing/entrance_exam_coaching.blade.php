          ...
          <div class="tab-content ">
            <div class="tab-pane " id="engineering">
              <div class="tab-inner">
				...
				<div class="single-awesome-project">
					...
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Preparing for the COMEDK undergraduate entrance test, a test for engineering and architecture. Many institutes provide coaching in COMEDK but how to choose the best, here comes quickdials; we help candidates to find the perfect spot for getting trained in best coaching centers.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					...
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Want to get enrolled in West Bengal Board of Secondary Education, well this is the best time. quickdials provides end to end support for WBSEE admissions. Don’t miss the opportunity many have already enrolled time for you to take action.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
            ...
            <div class="tab-pane active" id="university">
              <div class="tab-inner">
				...
				<div class="single-awesome-project">
					...
					</div><div class="icon"><i class="fa fa-institution"></i></div><p>Want to make your career in SSC to join ministries and government organization. Prepare for CGL. We provide the best way to institutes for you so you can mark success in your life. Choose quickdials.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
           ...
           <div class="tab-pane" id="PharmacyEntrance">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
				<div class="single-awesome-project">
				<div class="awesome-img">
				<a href="javascript:void(0);"><img loading="lazy" src="{{asset('landing/img/portfolio/6.jpg')}}" alt="" /></a>
			...
			<div class="single-awesome-project">
			<div class="awesome-img">
			<a href="javascript:void(0);"><img loading="lazy" src="{{asset('landing/img/portfolio/5.jpg')}}" alt="" /></a>
			<div class="add-actions text-center">
			<div class="project-dec">
        ...
        <div class="team-top">
            ...
            <div class="single-team-member">
              <div class="team-img">
                <a href="javascript:void(0);">
					<img loading="lazy" src="{{asset('landing/img/team/1.jpg')}}" alt="">
					</a>
              ...
              <div class="team-content text-center">
                <h4>Akash Gupta</h4>
                    <p> <img loading="lazy" src="{{ asset('client/images/star_4.75_new.png') }}"  ></p>
              </div>
            </div>
          </div>
          <!-- End column -->
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="javascript:void(0);">
										<img loading="lazy" src="{{asset('landing/img/team/2.jpg')}}" alt="" >
									</a>
                <div class="team-social-icon text-center">
              ...
              <div class="team-content text-center">
                ...
                <p> <img loading="lazy" src="{{ asset('client/images/star_4_new.png') }}"  ></p>
              </div>
            </div>
          </div>
          <!-- End column -->
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="javascript:void(0);">
										<img loading="lazy" src="{{asset('landing/img/team/3.png')}}" alt="">
									</a>
                <div class="team-social-icon text-center">
              ...
              <div class="team-content text-center">
                <h4>Sweta Jha</h4>
             <p> <img loading="lazy" src="{{ asset('client/images/star_4.5_new.png') }}"  ></p>
              </div>
            </div>
          </div>
          <!-- End column -->
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="javascript:void(0);">
				 <img loading="lazy" src="{{asset('landing/img/team/4.png')}}" alt="" >
									</a>
                <div class="team-social-icon text-center">
              ...
              <div class="team-content text-center">
                <h4>Ravi Kumar</h4>
               <p> <img loading="lazy" src="{{ asset('client/images/star_5_new.png') }}"  ></p>
              </div>
            </div>
          </div>
          <!-- End column -->
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-left">
            <div class="single-well">
              <a href="javascript:void(0);">
								  <img loading="lazy" src="{{asset('landing/img/about_quickdials.jpg')}}" alt="">
								</a>
            </div>
          </div>
        </div>
            ...
            <div class="panel-group" id="accordions">
              ...
              <div class="panel panel-default">
                ...
                <div id="check8" class="panel-collapse collapse">
                  <div class="panel-body">
                    <p>
                    For More Info & any Queries, you can Contact Us on 7559435943 or reach out to us via e-mail @ Info@quickdials.com, or drop a quick Enquiry Our Expert counseling team Will Contact you Soon.
                    </p>
                  </div>
                </div>
              </div>
             ...
             <div class="col-xs-12 col-sm-12 col-md-12 form-proceed spacer">
                <div class="col-xs-12 col-sm-6 col-md-6 border-line formleftBlock">
				 ...
				 <div class="heading-txt">Why Fill This Form?</div>
                    <ul class="whyChoose">
                        <li><span><img loading="lazy" src="<?php echo asset('client/images/icon-1.png'); ?>"></span>Thousands of students fill this form to get best deals for the preparation of entrance exams.</li>
                        <li><span><img loading="lazy" src="<?php echo asset('client/images/icon-2.png'); ?>"></span>Only certified Institutes will contact you with best deals with Full details.</li>
                        <li><span><img loading="lazy" src="<?php echo asset('client/images/icon-3.png'); ?>"></span>We Tried to fulfilled your requirements as soon as possible.</li>
                        <li><span><img loading="lazy" src="<?php echo asset('client/images/icon-1.png'); ?>"></span>UNIT 101 OXFORD TOWERS, 139/88 HAL OLD AIRPORT RD, H.A.L II Stage, Bangalore North, Bangalore- 560008, Karnataka, Email:- info@quickdials.com, Phone:-9818798937, Website:- www.quickdials.com</li>
                    </ul>
                </div>
