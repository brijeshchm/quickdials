        ...
        <div class="section-border">
            ...
            <form class="form-horizontal" method="POST" onsubmit="return keywordController.updatePageContent(this,<?php echo (isset($keyword->id)? $keyword->id:""); ?>)" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea class="form-control" name="top_description" rows="9" placeholder="Enter Page Top Description">{{ $keyword->top_description }}</textarea>
                    </div>
                </div>
            <div class="form-group ">
                <label for="bottom_description" class="col-md-2 control-label">Page Bottom Description</label>
                <div class="col-md-8">
                <textarea class="form-control" name="bottom_description" placeholder="Enter Page Bottom Description" rows="15">{{ $keyword->bottom_description }}</textarea>
                </div>
            </div>	
            <div class="form-group text-center">
            <button type="submit" class="btn btn-primary">
