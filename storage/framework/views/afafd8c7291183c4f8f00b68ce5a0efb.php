...
<div class="container">
        <div class=" form-section">
            <div class="removeLeftSpace">
			 ...
			 <a href="<?php echo e(url('child/')); ?>/<?php if(!empty($keyword->child_category)) { echo generate_slug($keyword->child_category); } ?>" >Categories / <?php if(!empty($keyword->child_category)) { echo $keyword->child_category; } ?></a> 
...
<?php endif; ?>
    ...
    <div class="col-sm-9 col-md-9 reviews-box-main mainContainer">
	 ...
	 <?php if(isset($keyword) && null!=$keyword->top_description): ?>
		...
		<p title="<?php if(!empty($keyword->keyword)) { echo $keyword->keyword; } ?> in <?php echo e(Request::segment(1)); ?>"><?php  if(!empty($keyword->top_description)){
    ...
    <div class="category-box">
	   <div class="business-services">
		...
		<?php if(!empty($childCategory)): ?>
			<?php $__currentLoopData = $childCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(!empty($child->keyword)): ?>
            <li class="">
            ...
            <img loading="lazy" src="<?php echo e(asset(''.$data['src'])); ?>" alt="<?php echo e($data['name']); ?>" >

            <?php  }   } ?>
            <a href="<?php echo e(generate_slug($child->keyword)); ?>" title="<?php if(!empty($child->keyword)) { echo $child->keyword; } ?>" class="keystore"><?php if(!empty($child->keyword)) { echo $child->keyword; } ?></a> 
...
<li style="font-size: 13px;"> <?php echo str_replace('?','',$keyword->courseabout); ?></li>
 <?php endif; ?>
<ul>
...
<?php if($keyword->paragraph2): ?>
 <li><p style="font-size: 13px;">  <?php echo str_replace('?','',$keyword->paragraph2); ?></p> </li>
 <?php endif; ?>

<?php if($keyword->paragraph3): ?>
 <li><p style="font-size: 13px;"> <?php echo str_replace('?','',$keyword->paragraph3); ?> </p> </li>
 <?php endif; ?>
 
 <?php if($keyword->paragraph4): ?>
 <li><p style="font-size: 13px;">  <?php echo str_replace('?','',$keyword->paragraph4); ?> </p> </li>
 <?php endif; ?>
 
 <?php if($keyword->paragraph5): ?>
 <li><p style="font-size: 13px;">  <?php echo str_replace('?','',$keyword->paragraph5); ?></p> </li>
 <?php endif; ?>
 
 
 <?php if($keyword->paragraph6): ?>
 <li><p style="font-size: 13px;">  <?php echo str_replace('?','',$keyword->paragraph6); ?> </p> </li> 
<?php endif; ?>
  </ul>	
 	 </ul> 
</div> </div> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/quickdials/public_html/resources/views/client/child.blade.php ENDPATH**/ ?>