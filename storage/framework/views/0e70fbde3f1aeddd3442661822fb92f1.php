<?php $__env->startSection('title'); ?>
	 <?php echo e($client->business_name); ?> | Quick Dials
...
?>
            ...
            <div class="photo small"
				 ...
				 <a href="javascript:void(0);" data-t_img="#<?php echo ($key + 1); ?>" class="lightBox"><span>
									...
									<img loading="lazy" src="<?php echo asset('' . $img['large']['src']); ?>"
										alt="<?php echo e($img['large']['name']); ?>" class="img-responsive">
									<?php } ?>
								</span></a>
 ...
 <div class="photo add-more">
            <span>📷<br>	
			<a href="<?php echo e(url('business/gallery-pictures')); ?>" >Add More Photo</a>		
		</span>
        </div>
...
<?php }else{ ?>
			...
			<div class="removeLeftSpace">
				<h3 class="hdTitle">
					Are you looking for options other than <span
						class="croma-txt"><?php echo e(isset($client->business_name) && !empty($client->business_name) ? $client->business_name : ""); ?>
					...
					if (!empty($client->logo)) {
						...
						$imageName = $logo['large']['name'];
										...
										<img loading="lazy" src="<?php echo asset('' . $image); ?>" style="margin-bottom:15px;border-radius:0"
											class="img-responsive" alt="<?php echo e($imageName); ?>">
										<?php } ?>
									</div>
				...
				<aside class="addressBlock">
					...
					if (!empty($addr->ispositiveresponse)) {
						...
						<li><i class="fa fa-fw fa fa-envelope location-icon-1" aria-hidden="true"></i><a
								href="<?php echo e(isset($client->email) && !empty($client->email) ? "mailto:" . $client->email : "#"); ?>">Send
								Enquriy By Mail</a></li>
						<li><i class="fa fa-fw fa fa-chrome location-icon-1" aria-hidden="true"></i>


							<a target="_blank"
								href="<?php echo e(isset($client->website) && !empty($client->website) ? buildWebsiteURL($client->website) : 'javascript:void(0)'); ?>">


								<?php echo e(isset($client->website) && !empty($client->website) ? $client->website : 'Website Not Available'); ?>
	...
	if (isset($client->certifications) && !empty($client->certifications)) { 				
				...
				<aside>
					<h4>Certifications 	<?php if($client->certified_status): ?>					 
				...
				<aside>
					<h4>Trusted	<?php if($client->trusted_status): ?>
				...
				<?php endif; ?>
				<?php if($client->msme_certificate): ?>	
				<aside>
					<h4>GST 	<?php if($client->gst_status): ?> 
							<img loading="lazy" src="<?php echo e(asset('img/q_gst.gif')); ?>">
							<?php endif; ?>		<?php if(!empty($client->gst_no)): ?>
					<?php echo e($client->gst_no); ?>
				...
				<?php if($client->cin_certificate): ?>	
				<aside>
					<h4>CIN no 	<?php if(!empty($client->cin_no)): ?>
					<?php echo e($client->cin_no); ?>
				...
				<?php endif; ?>
				<?php if($client->iso_certificate): ?>	
				<aside>
					<h4>ISO No 	<?php if(!empty($client->iso_no)): ?>
					<?php echo e($client->iso_no); ?>
				...
				<?php endif; ?>
				<?php if($client->msme_no): ?>	
				<aside>
					<h4>MSME No 	<?php if(!empty($client->msme_no)): ?>
					<?php echo e($client->msme_no); ?>
					...
					<?php endif; ?>
				<?php if(!empty($client->award_img1)): ?>
					<aside>
						<h4>Award </strong>

						<h5>
							<?php if($client->award_img1): ?>
							<?php   
				...
				<?php endif; ?>
				<?php if(!empty($client->award_img2)): ?>
					<aside>
						<h4>Award </strong>

						<h5>
							<?php if($client->award_img2): ?>
							<?php   
				...
				<?php endif; ?>
				<?php if(!empty($client->award_img3)): ?>
					<aside>
						<h4>Award </strong>

						<h5>
							<?php if($client->award_img3): ?>
							<?php   
				...
				<?php if(!empty($client->award_img4)): ?>
					<aside>
						<h4>Award </strong>

						<h5>
							<?php if($client->award_img4): ?>
							<?php   
				...
				<?php endif; ?>
				<?php if(!empty($client->award_img5)): ?>
					<aside>
						<h4>Award </strong>

						<h5>
							<?php if($client->award_img5): ?>
							<?php   
					...
					<div class="top-details">
						<aside>
							<h2 class="details-txt"><a target="_blank"
									href="<?php echo e(isset($client->website) && !empty($client->website) ? buildWebsiteURL($client->website) : 'javascript:void(0);'); ?>"><?php echo e(isset($client->business_name) && !empty($client->business_name) ? $client->business_name : ""); ?></a>

							</h2>
							<div class="rating"><span class="green"><?php echo e($avgRating); ?></span> <span class="starvote">
							<?php
							...
							?>
								...
								</span> <span class="vote"><?php echo e($count); ?> Votes</span></div>
	...
	<div id="intro"> 
		<h1><i class="fa fa-user fa-fw" style="margin-right:5px;"></i><?php echo e($client->business_name); ?>

		&nbsp;&nbsp;&nbsp;<i class="fa fa-map-marker fa-fw"
		style="margin-right:5px;"></i><?php echo e($client->city); ?></h1>
		<div class="inner-intro">
		<p style="text-align:justify;margin-left: 27px;">

							
		<?php if($client->business_intro): ?>
		<?php echo $client->business_intro; ?>
	...
	<h3><i class="fa fa-map-marker fa-fw" style="margin-right:5px;"></i>Serving in City/Cities</h3>
		...
		<div class="services">
				...
				<?php if(!empty($assignedCity)): ?>
				<?php $__currentLoopData = $assignedCity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			 
				<span class='service'><?php echo e($city->city); ?></span>
...
<div class="section">
    ...
    <div class="certificate-layout">
		...
		<?php if(!empty($client->msme_certificate)): ?>
			<?php
			...
			<?php if($msmeImage): ?>
				<div class="cert-item">
					...
					data-image="<?php echo e(asset($msmeImage)); ?>">
					
						<img loading="lazy" src="<?php echo e(asset($msmeImage)); ?>" alt="MSME Certificate">
					</a>
				</div>
			<?php endif; ?>
...
<?php if(!empty($client->cin_certificate)): ?>
    <?php
    ...
    <?php if($cinImage): ?>
        <div class="cert-item">
            <a href="javascript:void(0);"
               class="lightbox-trigger"
               data-image="<?php echo e(asset($cinImage)); ?>">
               
                <img loading="lazy" src="<?php echo e(asset($cinImage)); ?>" alt="CIN Certificate">
            </a>
        </div>
    <?php endif; ?>
	<?php else: ?>
...
<?php if(!empty($client->iso_certificate)): ?>
    <?php
    ...
    <?php if($isoImage): ?>
        <div class="cert-item">
            <a href="javascript:void(0);"
               class="lightbox-trigger"
               data-image="<?php echo e(asset($isoImage)); ?>">
               
                <img loading="lazy" src="<?php echo e(asset($isoImage)); ?>" alt="ISO Certificate">
            </a>
        </div>
    <?php endif; ?>
...
<?php if(!empty($client->award_img1)): ?>
    ...
    <?php if($awardImg1): ?>
        <div class="cert-item">
            <a href="javascript:void(0);"
               class="lightbox-trigger"
               data-image="<?php echo e(asset($awardImg1)); ?>">
               
                <img loading="lazy" src="<?php echo e(asset($awardImg1)); ?>" alt="Award 1">
            </a>
        </div>
    <?php endif; ?>
...
<?php if(!empty($client->award_img2)): ?>
    ...
    <?php if($award2Img): ?>
        <div class="cert-item">
            <a href="javascript:void(0);"
               class="lightbox-trigger"
               data-image="<?php echo e(asset($award2Img)); ?>">
               
                <img loading="lazy" src="<?php echo e(asset($award2Img)); ?>" alt="Award 2">
            </a>
        </div>
    <?php endif; ?>
...
<?php if(!empty($client->award_img3)): ?>
    ...
    <?php if($award3Img): ?>
        <div class="cert-item">
            <a href="javascript:void(0);"
               class="lightbox-trigger"
               data-image="<?php echo e(asset($award3Img)); ?>">
               
                <img loading="lazy" src="<?php echo e(asset($award3Img)); ?>" alt="Award 3">
            </a>
        </div>
    <?php endif; ?>
...
<?php if(!empty($client->award_img4)): ?>
    ...
    <?php if($award4Img): ?>
        <div class="cert-item">
            <a href="javascript:void(0);"
               class="lightbox-trigger"
               data-image="<?php echo e(asset($award4Img)); ?>">
               
                <img loading="lazy" src="<?php echo e(asset($award4Img)); ?>" alt="Award 4">
            </a>
        </div>
    <?php endif; ?>
...
<?php if(!empty($client->award_img5)): ?>
    ...
    ?>
<iframe src="<?php echo e(asset($award5Img)); ?>" style="width: 100px;height: 100px;border: none;"></iframe>
    <?php if($award5Img): ?>
        <div class="cert-item">
            <a href="javascript:void(0);"
               class="lightbox-trigger"
               data-image="<?php echo e(asset($award5Img)); ?>">
               
                <img loading="lazy" src="<?php echo e(asset($award5Img)); ?>" alt="Award 3">
            </a>
        </div>
    <?php endif; ?>
<?php endif; ?>
											...
											<div class="row">
												<label class="col-xs-12 col-sm-2 col-md-2 contlftspce review-txt">Rating
													...
													<input type="hidden" name="s_rating" class="col-xs-12 col-sm-5 col-md-5 txtfld jinp">
														...
														<input type="hidden" name="currentClient" value="<?php echo e($client->id); ?>">
																	</div>
											</div>
								...
								<div class="col-xs-12 col-sm-12 col-md-12" id="reviews-result-resp">
									<?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<div class="reviews-box">
																<div class="alllearners_reviews clearfix">
																	...
																	<div class="alllearners_reviews_info_box">
																		<h5><span style="color:#333;"><?php echo e($comment->comment_author); ?> </span> <span
										...
										for ($i = 0; $i < $remain; ++$i) {
											echo "<a href=\"javascript:void(0)\" class=\"emptystar\"></a>";
																		...
																		<h6 class="reviewer_profession" style="color:#2874F0">
																			[<?php echo e(getStarCodedStr($comment->comment_author_email, 'email')); ?> |
																			<?php echo e(getStarCodedStr($comment->comment_author_phone, 'number')); ?>] <span
																				class="com-date pull-right"><?php echo e(date_format(date_create($comment->created_at), "dS-M\' Y")); ?></span>
																		</h6>
																	</div>
																</div>
										...
										if ($addr->ispositiveresponse) {
																		?>
																	<?php if ($addr->issubstr): ?>
																	<p class="reviewsquots_info reviewsquots_txt"><?php echo e($addr->substr); ?> </p>
																	<a data-content="<?php echo e($addr->fullstr); ?>" class="r-more-info" type="button">More
																		&gt;&gt;</a>
																	<?php else: ?>
																	<p class="reviewsquots_info reviewsquots_txt"><?php echo e($addr->fullstr); ?></p>
																	<?php endif; ?>
																	<?php
										}
																		?>
...
<div class="modal fade" id="g_MapsModal" tabindex="-1" role="dialog"
		...
		<li><i class="fa fa-fw fa fa-institution location-icon-1"
				...
				style="font-weight:bold;font-size:20px;"><strong><?php echo e($client->business_name); ?></strong></span>
		</li>
		<li><i class="fa fa-fw fa-map-marker location-icon-1"
				aria-hidden="true"></i><span
				class="phone-txt"
				id="g_MapName"><?php echo e($client->address); ?></span>
		</li>
		<!--<li><i class="fa fa-fw fa fa-phone-square location-icon-1" aria-hidden="true"></i><span class="phone-txt"><?php echo e(isset($client->landline)&&!empty($client->landline)?"(+91)"."-".$client->stdcode."-".$client->landline:""); ?></span></li>
		<li><i class="fa fa-fw fa fa-mobile location-icon-1" aria-hidden="true"></i><span class="phone-txt"><?php echo e(isset($client->mobile)&&!empty($client->mobile)?"(+91)".$client->mobile:""); ?><?php echo e((isset($client->mobile,$client->sec_mobile)&&!empty($client->sec_mobile)&&!empty($client->mobile))?", ":""); ?><?php echo e(isset($client->sec_mobile)&&!empty($client->sec_mobile)?"(+91)".$client->sec_mobile:""); ?></span></li>-->
		...
		<li><i class="fa fa-fw fa fa-chrome location-icon-1"
				aria-hidden="true"></i><a
				href="<?php echo e(isset($client->website) && !empty($client->website) ? $client->website : 'javascript:void(0)'); ?>"><?php echo e(isset($client->website) && !empty($client->website) ? $client->website : 'Website Not Available'); ?></a>
		</li>
		</ul>
		</div>
		</div>
	...
	<div class="galleryPopup">
		<div class="popwraper whiteBg">
			...
			<div id="gallery" class="content">
				<div class="topinfo">
					<strong><?php echo e((isset($client->business_name) && !empty($client->business_name)) ? $client->business_name . "," : ""); ?></strong>
					<?php if ($addr->ispositiveresponse) { ?>
					<?php if ($addr->issubstr): ?>
					<?php echo e($addr->substr); ?>

					<a href="javascript:void(0)" style="color:red" data-toggle="tooltip" data-placement="bottom" title=""
						data-original-title="<?php echo e($addr->fullstr); ?>">more</a>
					<?php else: ?>
					<?php echo e($addr->fullstr); ?>
...
document.getElementById('lightbox').addEventListener('click', e => {
 ...
 <script src="<?php echo e(asset('client/js/jquery.galleriffic.js')); ?>" defer></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/quickdials/public_html/resources/views/client/client-detail.blade.php ENDPATH**/ ?>