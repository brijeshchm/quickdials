   ...
   <div class="clearfix"></div>   
    ...
    <div class="container">
        <div class="col-sm-9 col-md-9 reviews-box-main mainContainer">
			...
			<?php if($clientskeyword->isNotEmpty()): ?>
				<?php $n=0;?>
				...
				<div class="col-sm-12 col-md-12 reviews-box-1 line-content">
					...
					<div class="col-sm-4 col-md-4 serchlist-img "><a href="<?php echo e(url('business-details')."/".$client->business_slug); ?>" title="<?php echo e($client->business_name or ""); ?>">
				 ...
				 <?php if($client->certified_status): ?>		 
					...
					<?php endif; ?>
						<a href="<?php echo e(url('business-details')."/".$client->business_slug); ?>" title="<?php echo e($client->business_name or ""); ?>">
						...
						<div class="serchlist-txt"><i class="fa fa-fw fa-clock-o serchlist-icon" aria-hidden="true"></i>
							<a href="<?php echo e(url('business-details')."/".$client->business_slug); ?>" title="<?php echo e($client->business_name or ""); ?>"><span class="serchlist-txt">
							<?php
						...
						<div class="serchlist-txt-btn"><a href="javascript:void(0);" title="<?php echo e($client->business_name or ""); ?>" class="sms-view open-popup"><span>Enquiry Now</span></a>&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" title="<?php echo e($client->business_name or ""); ?>" class="whatsapp-view open-popup"><span><i class="fa fa-whatsapp"></i> WhatsApp</span></a> &nbsp;&nbsp;&nbsp;<a href="<?php echo e(url('business-details')."/".$client->business_slug); ?>" title="<?php echo e($client->business_name or ""); ?>" class="sms-view"><span>Vew Details</span></a></div>
					...
					<button class="serchlist-btn" title="Best Offer <?php echo e($client->business_name or ""); ?>">Enquiry Now</button>
					</div>

					<div class="col-sm-12 col-md-12" style="padding-left:0;">
						<div class="clickBlick"><a href="<?php echo e(url('business-details').'/'.$client->business_slug.'/#rewandrate'); ?>" title="<?php echo e($client->business_name or ""); ?>"><i class="fa fa-fw fa fa-sun-o" aria-hidden="true"></i></a><a href="<?php echo e(url('business-details').'/'.$client->business_slug.'/#rewandrate'); ?>" title="<?php echo e($client->business_name or ""); ?>"><span>Click here to view your friend rating</span></a></div>
					</div>
...
<span><?php echo $keyword->heading; ?></span> </button> </h2></div>
			...
			<?php $__currentLoopData = $reviewsClientsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			 ...
			 <div class="reviews-client-box">
					...
					<div class="serchlist-txt">
						...
						<a href="<?php echo e(url('business-details/' . $client->business_slug)); ?>"> <span class="serchlist-rating"> (<?php echo e($avgRating ?? 0); ?> Rating out of <?php echo e($client->comment_count ?? 0); ?> Votes) </span>
						</a>
					</div>
	   ...
	   <div class="col-xs-12">
		...
		<?php if(!empty($clientLists)): ?>
			...
			?>
				...
				<figure><img loading="lazy" class="" src="<?php echo url($image); ?>"  alt="<?php echo e($client->business_name); ?>" style="width:100%;"></figure>
				<div class="grid-info">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/quickdials/public_html/resources/views/client/parentKeyword.blade.php ENDPATH**/ ?>