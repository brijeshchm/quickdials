            ...
            <div class="row">
               <div class="col-sm-4 col-md-4 col-xs-12">
                    <div class="business-quickrequestfotm">
                        ...
                        <form class="form-style-9" id="business-form" action="<?php echo e(url('/business-owners')); ?>" method="POST">
                            <?php echo e(csrf_field()); ?>


                            <p><input type="text" placeholder="Business/Company Name" class="pull-left" autocomplete="off"
                                    name="business_name" value="<?php echo e(old('business_name')); ?>"></p>

                            <p><input type="email" class="field-style pull-left" placeholder="Enter Email" name="email"
                                    value="<?php echo e(old('email')); ?>"></p>
                            <p>
                                <style>
                                    @media (max-width: 767px) {
                                        .fixedform {
                            ...
                            <div class="div-code">
                                <div class="drop-number dropwn">
                                    ...
                                    <div class="quick_arrow form-group">
                                        <input type="tel" class="quick-remove" name="mobile" maxlength="15" value="<?php echo e(old('mobile')); ?>" placeholder="Phone No*">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm-4 col-md-4 col-xs-12">
                    ...
                    <div class="banner-steps banner-stepsInternalEven">
                        <div class="bstep1">
                            ...
                            <img loading="lazy" class="banimgInt" style="height: 37px; width: 37px;"
                                src="<?php echo e(asset('images/grow-client.png')); ?>" alt="buyer">
                            <figcaption class="banimghdr" style="display: block; font-size: 20px;"> <span
                                    class="count"><?php echo e($clients); ?></span> +</figcaption>
                        ...
                        <div class="bstep1">
                            <img loading="lazy" style="width: 47px;" class="banimgInt" src="<?php echo e(asset('images/Suppliers.png')); ?>"
                                alt="supplier">
                        ...
                        <div class="bstep1"><img loading="lazy" class="banimgInt" style="width: 37px;"
                                src="<?php echo e(asset('images/Products-services-grow.png')); ?>" alt="Products-services-grow">
                    ...
                    <div class="banner-steps banner-stepsInternalEven">
                        <div class="bstep1">
                            ...
                            <img loading="lazy" class="banimgInt" style="height: 37px; width: 37px;"
                                src="<?php echo e(asset('images/keyword-grow.png')); ?>" alt="prodnserv">
                            <figcaption class="banimghdr" style="display: block; font-size: 20px;"> <span
                                    class="count"><?php echo e($keyword); ?></span> +</figcaption>
                            <figcaption class="banimgDir" style="display: none;"> Grow your Business </figcaption>
                        ...
                        <div class="bstep1">
                            <img loading="lazy" style="width: 47px;" class="banimgInt" src="<?php echo e(asset('images/Store-grow.png')); ?>"
                                alt="prodnserv">
                        ...
                        <div class="bstep1"><img loading="lazy" class="banimgInt" style="width: 37px;"
                                src="<?php echo e(asset('images/Platform.png')); ?>" alt="prodnserv">
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <p class="fade-in" style="transition-delay: 0.2s">
                    India’s Local Search Engine – Reach <?php echo e($clients); ?> + Buyers and Skyrocket Your Business Growth
            ...
            <div class="features-grid">
                ...
                <div class="feature-card fade-in-left">
                    <div class="feature-icon">
                        <img loading="lazy" src="<?php echo e(asset('img/google-maps.png')); ?>" alt="Google map">
                    </div>
                ...
                <div class="feature-card fade-in" style="transition-delay: 0.2s">
                    <div class="feature-icon">
                        <img loading="lazy" src="<?php echo e(asset('img/local-keyword.png')); ?>" alt="local-keyword">
                ...
                <div class="feature-card fade-in-right" style="transition-delay: 0.4s">
                    <div class="feature-icon">
                        <img loading="lazy" src="<?php echo e(asset('img/call-form.png')); ?>" alt="call-form">
                    </div>
                ...
                <div class="feature-card fade-in-left" style="transition-delay: 0.2s">
                    <div class="feature-icon">
                        <img loading="lazy" src="<?php echo e(asset('img/lead-capture.png')); ?>" alt="lead-capture">
                ...
                <div class="feature-card fade-in" style="transition-delay: 0.4s">
                    <div class="feature-icon">
                        ...
                        <img loading="lazy" src="<?php echo e(asset('img/review-putation.png')); ?>" alt="review-putation">
                ...
                <div class="feature-card fade-in-right" style="transition-delay: 0.6s">
                    <div class="feature-icon">
                        ...
                        <img loading="lazy" src="<?php echo e(asset('img/citation-building.png')); ?>" alt="citation-building">
        ...
        <div class="container">
            ...
            <div class="stats-container">
                <div class="stat-item fade-in">
                    <div class="stat-number" id="stat1"><?php echo e($clients); ?>+</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/quickdials/public_html/resources/views/client/business-owners.blade.php ENDPATH**/ ?>