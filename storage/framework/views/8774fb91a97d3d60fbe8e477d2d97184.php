...
<head>
	...
	<script data-cfasync="false" src="<?php echo asset('vendor/spinner/spin.min.js'); ?>"></script>
  	...
  	<link rel="stylesheet" href="<?php echo e(asset('admin/vendor/chosen-js/chosen.css')); ?>">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(url('developer/dashboard')); ?>">Quick Dials</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
				...
				<?php if(Auth::user()->current_user_can('administrator')): ?>
                    ...
                    <?php if(Request::segment(2)=='dashboard' || Request::segment(2) =='lead-dashboard'): ?>
                        ...
                        <select class="form-control select2-single counsellor-control"  >
                            ...
                            <?php if(isset($getUserList)): ?>
                                <?php $__currentLoopData = $getUserList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $counsellor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($counsellor->id); ?>" <?php if(Request::segment(3)==$counsellor->id) { echo "selected"; } ?> ><?php echo e($counsellor->first_name); ?> <?php echo e($counsellor->last_name); ?></option>
        ...
        </nav><?php /**PATH /home/quickdials/public_html/resources/views/admin/header.blade.php ENDPATH**/ ?>