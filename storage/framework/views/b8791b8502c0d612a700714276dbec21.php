	...
	<form class="lead_Form" id="lead_Form" onsubmit="return homeController.saveTwoEnquiry(this)" method="POST">
		...
		<div class="side-step-from">
			...
			<div class="terms">
				...
				I agree to the Quickdials terms and conditions <a href="<?php echo e(url('terms-conditions')); ?>" target="_blank">Terms &
					Conditions</a>
			</div>
...
<div class="side-row-1">
 ...
 <?php echo $__env->make('client.layouts.model_popup', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH /home/quickdials/public_html/resources/views/client/layouts/common_sidebar_form.blade.php ENDPATH**/ ?>