...
<?php $__env->startSection('content'); ?>	 
	...
	<div class="container">
        ...
        ?>
			...
			<a href="<?php echo e(url('child/wedding-planning/')); ?>" title="wedding-planning">Wedding Planning</a> 			 
...
$value = Cookie::get('showPopup');	 
	//	if(Auth::guard('clients')->check() || ($value =="yes"))
	   ...
	   <h4>Need Expert Advice ?</h4>
        <div class="jbt"> Fill this form to Grab the best Deals on "<span class="orng"> <?php echo e(Request::segment(1)); ?></span>"</div>
        <div class="bdc">
            ...
            <form class="form-inline" action="" method="post" onsubmit="return homeController.saveEnquiry(this)">
                <aside>
					...
					<label for="yn">Your Name <span>*</span></label>
						...
						<input type="hidden" name="city_id" class="city" value="<?php echo e(Request::segment(1)); ?>" />
    ...
    <div class="bestModalpopup "> 
        ...
        <div class="right-panel">
            ...
            <p>Fill this form to Grab the best Deals on "<span class="orng"><?php echo e(Request::segment(1)); ?></span>"</p>
			<form class="popup-form" action="" method="post" onsubmit="return homeController.savePopEnquiry(this)">

			<input type="hidden" name="lead_form" value="1" />
			<input type="hidden" name="kw_text" value="" />
			<input type="hidden" name="city_id" class="city_id" value="<?php echo e(Request::segment(1)); ?>" />			 
			<input type="hidden" name="from_page" value="<?php echo e(request()->path()); ?>">
            ...
            <div class="terms">
                <input type="checkbox" /> I agree to the Quickdials terms and conditions <a href="<?php echo e(url('terms-conditions')); ?>">Terms & Conditions</a>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/quickdials/public_html/resources/views/client/wedding-planning.blade.php ENDPATH**/ ?>