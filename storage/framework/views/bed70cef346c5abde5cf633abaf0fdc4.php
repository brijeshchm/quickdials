<?php $__env->startSection('title'); ?> 
  <?php if(!empty($blogdetails?->meta_title)): ?>
    <?php echo e($blogdetails->meta_title); ?>

<?php endif; ?>
<?php $__env->stopSection(); ?> 

<?php $__env->startSection('keyword'); ?> 
    <?php if(!empty($blogdetails->meta_keyword)): ?> <?php echo e($blogdetails->meta_keyword); ?> 
    <?php else: ?> Best  in Noida | Delhi | Gurgaon 
    <?php endif; ?> 
<?php $__env->stopSection(); ?> 

<?php $__env->startSection('description'); ?> 
    <?php if(!empty($blogdetails->meta_description)): ?> <?php echo e($blogdetails->meta_description); ?> 
    <?php else: ?>  in Noida | Delhi | Gurgaon for Industrial Training. We conducts IT Software, Hardware, Network & Security Courses training. Corporate Trainer commands all training program. Week Days, Weekend, 6 Week, 6 Months Industrial Training are available 
    <?php endif; ?> 
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
 

  <link href="<?php echo e(asset('official/css/style.css')); ?>" rel="stylesheet">
 <style>
 .post-thumbnail img{
	     height: 350px;
    width: 900px;
      ...
      <div class="row">
				 ...
				 <div class="recent-single-post">
                    <div class="post-img">
                      <a href="<?php echo e(url('blog/'.$blog->slug)); ?>">
						<img loading="lazy" src="<?php echo (isset($image)?url($image):"");  ?>" width="70px" height="52px"  alt="<?php echo e($blog->name ?? ''); ?>">
						</a>
						</div>
                    <div class="pst-content">
                     <p> <a href="<?php echo e(url('blog/'.$blog->slug)); ?>"><?php echo e($blog->title); ?></a></p>
                    </div>
                  </div>
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          ...
          $image="";
						...
						?>
                  <img loading="lazy" src="<?php echo (isset($image)?url($image):"");  ?>"  alt="<?php echo e($blogdetails->name ?? ''); ?>" width: 900px; height: 350px;/>
                </div>
                ...
                <div class="post-information">
                  ...
                  <div class="entry-meta">
                    	...
                    	<?php if(!empty($blogdetails->ratingvalue)): ?>	
        <?php
        ...
        ?>
                ...
                based on <span itemprop="ratingCount"><?php echo e($blogdetails->ratingcount); ?></span> ratings
                </div>    
                </div>
                  <?php endif; ?>
                <div class="share-author">
                <span class="author-meta"><i class="fa fa-user"></i> <a href="javascript:void(0)"></a></span>
                    <span><i class="fa fa-clock-o"></i>  <?php if(!empty($blogdetails?->created_at)): ?>
...
<?php endif; ?></span>
                   ...
                   <div class="comment-box">
                        <div class="social-link-blog">
                           ...
                           <a href="https://www.facebook.com/sharer.php?u=<?php  echo url()->full(); ?>" target="_blank" class="" style="padding: 0px 7px;margin-top: -11px;">
                               ...
                               <img src="<?php echo e(asset('client/Facebook_icon.svg')); ?>">
                               
 
                               
                               </a>

                           <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php  echo url()->full(); ?>" data-via="<?php echo e($blogdetails->meta_title ?? ''); ?>" data-related="realdannys" data-hashtags="<?php echo e($blogdetails->meta_title ?? ''); ?>">
                               
                              <img src="<?php echo e(asset('client/twitter.svg')); ?>">
                            ...
                            <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php  echo url()->full(); ?>&title=<?php echo e($blogdetails->meta_title ?? ''); ?>" target="_blank" style="padding: 0px 7px;margin-top: -11px;"> 
                            
                            <img src="<?php echo e(asset('client/linkedin.svg')); ?>" >
                  ...
                  <div class="entry-content">
                   <p> <?php echo $blogdetails->description; ?></p>
                   ...
                   <div class="entry-content top_content">
                    <p><?php echo $blogdetails->top_content; ?></p>
                   ...
                   <div class="entry-content">
                    ...
                    ?>
                    <img loading="lazy" src="<?php echo (isset($image_banner)?url($image_banner):"");  ?>"  alt="<?php echo e($blogdetails->name ?? ''); ?>" style="width: 900px; height: 250px;"/>
                    </div>



                   <div class="entry-content bottom_content">
                   <p> <?php echo $blogdetails->bottom_content; ?></p>
...
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/quickdials/public_html/resources/views/official/blog-details.blade.php ENDPATH**/ ?>