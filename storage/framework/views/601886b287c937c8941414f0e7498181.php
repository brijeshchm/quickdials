              ...
              <!-- Table with stripped rows -->
				...
				<div class="row">
				     ...
				     <div id="leads_filter" class="col-md-12" style="border-bottom:2px solid #E6E9ED;margin-bottom:10px;padding-bottom:10px;">
                            ...
                            <input type="text" class="form-control leaddf"  value="<?php echo e(old('search[leaddf]',(isset($search['leaddf'])) ? $search['leaddf']:"")); ?>" name="search[leaddf]" placeholder="Create Date From">
                            </div>
                            <div class="col-md-4">
                            <label for="validationDefault02" class="form-label">Date To</label>
                            <input type="text" class="form-control leaddt"  value="<?php echo e(old('search[leaddt]',(isset($search['leaddt'])) ? $search['leaddt']:"")); ?>"  name="search[leaddt]" placeholder="Create Date To">
                            </div>
...
<?php echo $__env->make('business.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/quickdials/public_html/resources/views/business/leadlist.blade.php ENDPATH**/ ?>