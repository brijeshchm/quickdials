...
<img loading="lazy" src="<?php echo e(asset('client/images/about-us.png')); ?>" alt="about">
    ...
    <section class="stats">
        <div class="container">
            <div class="stats-grid">
                ...
                <div class="stat-box">
                    <h3><?php echo e($keyword); ?>+</h3>
                    <p>Service Keyword</p>
                </div>
                <div class="stat-box">
                    <h3><?php echo e($citieslists); ?>+</h3>
                    <p>Cities Covered</p>
                </div>
                <div class="stat-box">
                    <h3>99%</h3>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="about-move">
              <div class="services-details">
				...
				<img loading="lazy" alt="Leads Generation for Business" src="<?php echo e(asset('/public/client/images/business/group.png')); ?>">
										</a>
...
<div class="col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="about-move">
              <div class="services-details">
                <div class="single-services">
                  <a class="services-icon" href="javascript:void(0)">
										<img loading="lazy" alt="Real interactive class room" src="<?php echo e(asset('/public/client/images/business/customized-training.png')); ?>">
										</a>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="about-move">
              <div class="services-details">
                <div class="single-services">
                  <a class="services-icon" href="javascript:void(0)">
					<img loading="lazy" alt="Clearing of doubts using" src="<?php echo e(asset('/public/client/images/business/head_phone.png')); ?>">
										</a>
...
or making too many calls.</li>
   ...
   <div class="wellcome-area">
    ...
    <script src="<?php echo e(asset('official/contactform/contactform.js')); ?>"></script>
 <?php $__env->stopSection(); ?>

<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/quickdials/public_html/resources/views/official/about-us.blade.php ENDPATH**/ ?>