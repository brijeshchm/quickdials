...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('client/images/favicon.png')); ?>" type="image/png" />
    ...
    <meta name="identifier-URL" content="<?php echo e(url('/')); ?>">
    ...
    <meta name="DC.title" content="<?php echo $__env->yieldContent('keyword'); ?>" />
    ...
    <meta property="og:image" content="<?php echo e(asset('client/images/favicon.png')); ?>" />
    <meta property="og:image:secure_url" content="<?php echo e(asset('client/images/favicon.png')); ?>" />
    ...
    <meta name="twitter:keyword" content="<?php echo $__env->yieldContent('keyword'); ?>" />
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('description'); ?>" />
    <meta name="twitter:image" content="<?php echo e(asset('client/images/small-logo.jpg')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/select2/css/select2-combined.css')); ?>">
            ...
            <div class="head-list">
                <div class="logo">
                    <div title="Quick Dials">
                        <a href="<?php echo e(url('/')); ?>"><img src="<?php echo asset('client/images/small-logo.png'); ?>"
			...
			if (!Auth::guard('clients')->check()) { ?>
                ...
                <div class="head-right-lout">
                    <div class="head-left">
                        ...
                        <a href="<?php echo e(url('business-owners')); ?>" class="freelisting">
                    ...
                    <div class="head-right">
                        <a href="javascript:void(0);" id="login">Sign In</a> | <a href="<?php echo e(url('business-owners')); ?>"
        ...
        $image = $logo['large']['src'];
				?>
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="<?php echo e(url('business/dashboard')); ?>"
                                aria-expanded="true">
                                <?php 
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li>
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="<?php echo e(url('business/personal-details')); ?>">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="<?php echo e(url('business/account-settings')); ?>">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="<?php echo e(url('business/favorite-enquiry')); ?>">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="<?php echo e(url('business/manage-enquiry')); ?>">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="<?php echo e(url('business/keywords')); ?>">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="<?php echo e(url('business/package')); ?>">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="<?php echo e(url('business/billing-history')); ?>">
                                        <i class="bi bi-currency-rupee"></i>
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('client/logout')); ?>">
                                        <i class="bi bi-currency-rupee"></i>
                                        <span>Logout</span>
                                    </a>
                                </li>
                    ...
                    <a href="<?php echo e(url('business/dashboard')); ?>"><strong></strong></a>
                </div>
                <?php  } ?>
    ...
    <div class="container">
        <div class="main-footer">
            <div>
                ...
                <ul>
                    <li><a title="Coaching &amp; Tuitions" href="<?php echo e(url('coaching-tuitions')); ?>" tabindex="0">Coaching
                            &amp; Tuitions</a></li> |
                    <li><a title="Business Services" href="<?php echo e(url('business-services')); ?>" tabindex="0">Business
                            Services</a></li> |
                    <li><a title="Home Construction &amp; Renovation" href="<?php echo e(url('home-construction')); ?>"
                            tabindex="0">Home Construction &amp; Renovation</a></li> |

                    <li><a title="Personal Finance Services" href="<?php echo e(url('child/loan-service')); ?>"
                            tabindex="0">Personal Finance Services</a></li> |
                    <li><a title="Tours &amp; Travels" href="<?php echo e(url('categories/tours-travel-services')); ?>"
                            tabindex="0">Tours &amp; Travels</a></li> |
                    <li><a title="Property" href="<?php echo e(url('home-construction/property-dealer')); ?>" tabindex="0">Property
                            Dealer</a></li> |
                    <li><a title="Rentals" href="<?php echo e(url('Rentals')); ?>" tabindex="0">Rental Property</a></li> |
                    <li><a title="PG" href="<?php echo e(url('pg-hostels')); ?>" tabindex="0">PG & Hostel</a></li> |
                    <li><a title="Computer Courses & Training" href="<?php echo e(url('categories/computer-courses')); ?>"
                            tabindex="0">Computer Courses & Training</a></li> |

                    <li><a title="Study Abroad" href="<?php echo e(url('study-abroad')); ?>" tabindex="0">Study Abroad</a></li> |
                    <li><a title="Home Services" href="home-services" tabindex="0" class="keystore">Home Services</a>
                    </li> |
                    <li><a title="Parties, Special Occasions &amp; Wedding" href="<?php echo e(url('wedding-organizers')); ?>"
                            tabindex="0">Parties, Special Occasions &amp; Wedding</a></li> |
                    <li><a title="Electric Services" href="<?php echo e(url('categories/electric-services')); ?>"
                            tabindex="0">Electric Services</a></li> |
                    <li><a title="Government Exam" href="<?php echo e(url('categories/entrance-exams-coaching')); ?>"
                            tabindex="0">Government Exam</a></li> |
                    <li><a title="Electric Services" href="<?php echo e(url('web-designers')); ?>" tabindex="0">Web Designers</a></li>
                    |
                    <li><a title="Medical" href="<?php echo e(url('medical')); ?>" tabindex="0">Medical</a></li> |
                    ...
                    <li><a title="Health & Wellness" href="health-wellness" tabindex="0" class="keystore">Health &
                            Wellness</a></li> |
                    <li><a title="Yoga" href="<?php echo e(url('child/yoga-classes')); ?>" tabindex="0">Yoga</a></li> |
                    <li><a title="tax Consultants" href="<?php echo e(url('tax-consultants')); ?>" tabindex="0">CA & TAX
                            Consultants</a></li>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><a title="School Tuitions" href="coaching-tuitions" tabindex="0" class="keystore">Schools &
                            Colleges</a></li> |
                    <li><a title="Entrance Exam Coaching" href="<?php echo e(url('categories/entrance-exams-coaching')); ?>"
            ...
            <div>
                ...
                <ul>
                    <li><a title="Loans" href="<?php echo e(url('child/loan-service')); ?>" tabindex="0">Loans</a></li> |
            ...
            <div>
                ...
                <ul>
                    <li><a title="Chennai" href="<?php echo e(url('chennai')); ?>" tabindex="0">Chennai</a></li>
                    <li><a title="Mumbai" href="<?php echo e(url('mumbai')); ?>" tabindex="0">Mumbai</a></li>
                    <li><a title="Hyderabad" href="<?php echo e(url('hyderabad')); ?>" tabindex="0">Hyderabad</a></li>
                    <li><a title="Bangalore" href="<?php echo e(url('bangalore')); ?>" tabindex="0">Bangalore</a></li>
                    <li><a title="Delhi" href="<?php echo e(url('delhi')); ?>" tabindex="0">Delhi</a></li>
                    <li><a title="Kolkata" href="<?php echo e(url('kolkata')); ?>" tabindex="0">Kolkata</a></li>
                    <li><a title="Pune" href="<?php echo e(url('pune')); ?>" tabindex="0">Pune</a></li>
                    <li><a title="Ahmedabad" href="<?php echo e(url('ahmedabad')); ?>" tabindex="0">Ahmedabad</a></li>
                    <li><a title="Faridabad" href="<?php echo e(url('faridabad')); ?>" tabindex="0">Faridabad</a></li>
                    <li><a title="Ghaziabad" href="<?php echo e(url('ghaziabad')); ?>" tabindex="0">Ghaziabad</a></li>
                    <li><a title="Noida" href="<?php echo e(url('noida')); ?>" tabindex="0">Noida</a></li>
                    <li><a title="Gurgaon" href="<?php echo e(url('gurgaon')); ?>" tabindex="0">Gurgaon</a></li>
                    <li><a title="Greater Noida" href="<?php echo e(url('greaternoida')); ?>" tabindex="0">Greater Noida</a></li>
                    <li><a title="Chandigarh" href="<?php echo e(url('chandigarh')); ?>" tabindex="0">Chandigarh</a></li>
                    <li><a title="Coimbatore" href="<?php echo e(url('coimbatore')); ?>" tabindex="0">Coimbatore</a></li>
                    <li><a title="Jaipur" href="<?php echo e(url('jaipur')); ?>" tabindex="0">Jaipur</a></li>
                    <li><a title="Nagpur" href="<?php echo e(url('nagpur')); ?>" tabindex="0">Nagpur</a></li>
                    <li><a title="Surat" href="<?php echo e(url('surat')); ?>" tabindex="0">Surat</a></li>
                    <li><a title="Vadodara" href="<?php echo e(url('vadodara')); ?>" tabindex="0">Vadodara</a></li>
                    <li><a title="Vijayawada" href="<?php echo e(url('vijayawada')); ?>" tabindex="0">Vijayawada</a></li>
                    <li><a title="Visakhapatnam" href="<?php echo e(url('visakhapatnam')); ?>" tabindex="0">Visakhapatnam</a></li>
                    <li><a title="Indore" href="<?php echo e(url('indore')); ?>" tabindex="0">Indore</a></li>
                    <li><a title="Lucknow" href="<?php echo e(url('lucknow')); ?>" tabindex="0">Lucknow</a></li>
                </ul>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <div class="footr-new-right">
                        <div class="enquiry-img"><img loading="lazy" src="<?php echo e(url('images/enquiry-img.png')); ?>" alt="Project" width="100"
                                height="100"></div>
                        <h2>Do you have <br><span>any Requirement in your mind?</span></h2>
                        <div class="footer-get"> <a href="<?php echo e(url('business-owners')); ?>">Get Started </a>
                            <span>or</span> <a href="<?php echo e(url('business-owners')); ?>">Get Quote</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="footer-content">
                    <div class="footer-section">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="<?php echo e(url('blog')); ?>">Success Stories</a></li>
                            <li><a href="<?php echo e(url('blog')); ?>">Blog</a></li>
                            <li><a href="<?php echo e(url('business-owners')); ?>" rel="nofollow"
                                    title="Advertise on quickdials">Advertise on quickdials</a></li>
                            <li><a href="<?php echo e(url('/privacy-policy')); ?>" title="Privacy Policy">Privacy Policy</a></li>
                            <li><a href="<?php echo e(url('terms-conditions')); ?>" title="Terms & Conditions">Terms & Conditions</a>
                            </li>
                            <li><a href="<?php echo e(url('/copyright-policy')); ?>" title="Copyright Policy">Copyright Policy</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="footer-section">
                        ...
                        <ul class="footer-links">
                            <li><a href="<?php echo e(url('categories/professional-courses')); ?>">Coaching & Tuitions</a></li>
                            <li><a href="<?php echo e(url('child/wedding-planning')); ?>">Wedding Planning</a></li>
                            <li><a href="<?php echo e(url('category/health-wellness')); ?>">Healthcare</a></li>
                            <li><a href="<?php echo e(url('category/real-estate-agent')); ?>">Real Estate</a></li>
                            <li><a href="<?php echo e(url('categories/electric-services')); ?>">Electric Services</a></li>
                            <li><a href="<?php echo e(url('categories/security-system')); ?>">Security System</a></li>
                            <li><a href="<?php echo e(url('categories/medical')); ?>">Medical</a></li>
                            <li><a href="<?php echo e(url('child/packers-and-movers')); ?>">Packers Movers</a></li>
                    ...
                    <div class="footer-section">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="<?php echo e(url('categories/repairs-services')); ?>">Repairs Services</a></li>
                            <li><a href="<?php echo e(url('categories/spa')); ?>">SPA Beauty</a></li>
                            <li><a href="<?php echo e(url('child/loan-service')); ?>">Loan</a></li>
                            <li><a href="income-tax-consultants" class="keystore">Tax Consultants</a></li>
                            <li><a href="<?php echo e(url('interviews')); ?>">Interviews Question</a></li>
                        </ul>
                    </div>
                            ...
                            <div class="follow-sticker">
                                ...
                                <ul class="list-inline">
                                          <li><a class="facebook"
                                            ...
                                            title="Like us on Facebook" target="_blank"><img src="<?php echo e(asset('client/Facebook_icon.svg')); ?>" alt="Facebook_icon"></a></li>
                                    <li><a class="twitter" href="https://x.com/Quickdials"
                                            title="Follow us on Twitter" target="_blank"><img src="<?php echo e(asset('client/twitter.svg')); ?>" alt="twitter"></a></li>
                                    <li><a class="linkedIn" href="https://www.linkedin.com/company/quickdialsoffical"
                                            title="Follow us on Linkedin" target="_blank"><img src="<?php echo e(asset('client/linkedin.svg')); ?>" alt="linkedin"></a></li>
                                    ...
                                    <li><a class="pinterest" href="https://www.pinterest.com/quickdials12/"
                                            title="Follow us on Pinterest" target="_blank"><img src="<?php echo e(asset('client/pinterest.svg')); ?>" alt="pinterest"></i></a></li>
                                    <li><a class="instagram" href="https://www.instagram.com/quickdials1/"
                                            title="Follow us on Instagram" target="_blank"><img src="<?php echo e(asset('client/instagram.svg')); ?>" alt="instagram" ></i></a></li>
                ...
                <div class="disclaimer-box col-lg-7">
                    <div class="row">
                        <p>The certification names and logos are the trademarks of their respective owners. <a
                                href="<?php echo e(url('/privacy-policy')); ?>">View Disclaimer</a></p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 formright">
                ...
                <form action="" method="POST" autocomplete="on" id="login-form" class="text-center">
                    ...
                    <div class="google-login">
                        <a href="<?php echo e(url('/google-login')); ?>">
                            <img loading="lazy" src="<?php echo e(asset('client/g-logo.png')); ?>" alt="">
                            Login with Google
                        </a>
                    </div>
...
</html><?php /**PATH /home/quickdials/public_html/resources/views/client/layouts/app.blade.php ENDPATH**/ ?>