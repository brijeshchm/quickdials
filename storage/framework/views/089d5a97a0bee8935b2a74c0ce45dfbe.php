			...
			<div class="removeLeftSpace">
				<div class="hdTitle">
					<?php if(!empty($keyword)): ?>
						...
						switch ($rating) {
							...
							echo "1.0";
										...
										based on <span itemprop="ratingCount"><?php echo e($keyword->ratingcount); ?></span> ratings
									</div>
								</div>
					<?php endif; ?>
					<div class="keyword-cotegory-text">
						...
						<?php if(!empty($keyword)): ?>
										<a href="<?php echo e(url('child/' . $keyword->child_slug)); ?>" title="<?php if (!empty($keyword->child_category)) {
...
<div id="recentSearchContainer">
			...
			<?php if(!empty($clientsList->count())): ?>
				<?php			
					...
					<div class="col-sm-12 col-md-12 reviews-box-1 line-content">
						...
						foreach ($assignedKwds as $assignedKwd) {										 
								...
								<div class="serchlist-txt-btn"><a href="javascript:void(0);" title="<?php echo e($client->business_name); ?>"
										...
										target="_blank" rel="noopener noreferrer"><span><img src="<?php echo e(asset('client/WhatsApp.svg')); ?>" width="20">	
											WhatsApp</span></a> &nbsp;&nbsp;&nbsp;<a
										href="<?php echo e(url('business-details') . "/" . $client->business_slug); ?>"
								...
								<div class="card">
									<div class="card-header" id="abthdgOne">
										<h2 class="mb-0"><button type="button" class="btn-link"
												...
												<span><?php echo $keyword->heading; ?></span> </button> </h2>
									</div>
		...
		<div class="col-sm-3 col-md-3 side-data reviews-box-1 scroll-on rightsidedata">
			<?php echo $__env->make('client.layouts.sidebar_form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
		</div>
	</div>
	...
	<?php if(!empty($keyword)): ?>
		...
		<?php if(!empty($keyword) && $kwdsList->isNotEmpty()): ?>
				...
				<div class="category-box">
					<div class="course-program">
						...
						<ul class="">
							...
							<?php if(!empty($kwdsList)): ?>
								<?php $i = 0;
								$x = 5; ?>
								<?php $__currentLoopData = $kwdsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyicon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<li>
										...
										<img loading="lazy" src="<?php echo e(asset('' . $data['src'])); ?>" alt="<?php echo e($data['name']); ?>" width="25">

										<?php  }
										} ?>

										<a href="<?php echo e(url(strtolower(Request::segment(1)))); ?>/<?php echo generate_slug($keyicon->keyword) ?>"
											title="<?php if (!empty($keyicon->keyword)) {
											echo $keyicon->keyword;
										} ?> in <?php echo e(Request::segment(1)); ?>"><?php echo e($keyicon->keyword); ?>
						...
						<?php if(!empty($cities)): ?>
							...
							$x = 5; ?>
								<?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $citys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<li><a href="<?php echo e(url(strtolower($citys->city))); ?>/<?php if (!empty($keyword->keyword)) {
										echo generate_slug($keyword->keyword);
									} ?>" title="<?php if (!empty($keyword->keyword)) {
										echo $keyword->keyword;
									} ?> in <?php echo e(Request::segment(1)); ?>"><?php if(!empty($keyword->keyword)): ?><?php echo $keyword->keyword; ?><?php endif; ?>
											in <?php echo e($citys->city); ?> |</a></li>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						<?php endif; ?>
			...
			<div class="col-xs-12">
				...
				<div class="col-md-3">
					<div class="inner-client-div">
						...
						<figure><img loading="lazy" class="" src="<?php echo asset($image); ?>" alt="<?php echo e($client->business_name); ?>"
								style="width:100%;"></figure>
						<div class="grid-info">
							<h3><a href="<?php echo e(url('business-details') . '/' . generate_slug($client->business_slug)); ?>"
									title="<?php echo e($client->business_name); ?>" tabindex="0">
									<div title="<?php echo e($client->business_name); ?>"><strong><?php echo e($client->business_name); ?></strong>
									</div>
								</a></h3>

							<strong><?php echo e(ucfirst($client->city)); ?></strong>
							<a href="<?php echo e(url('business-details') . '/' . generate_slug($client->business_slug)); ?>"
		...
		<div class="callback-wrapper">
			...
			<div class="right-panel">
				...
				<p>Fill this form to Grab the best Deals on "<span
						class="orng"><?php echo isset($searchedKW) ? $searchedKW : ''; ?> In <?php echo e(Request::segment(1)); ?></span>"
				</p>
					...
					<form class="popup-form" id="leadForm" onsubmit="return homeController.saveTwoEnquiry(this)"
						...
						<div class="popup-step">
							...
							<div class="fieldblock">
								...
								<div class="erbr">
									<?php if($keyword->form_type == 'form_edu'): ?>
									...
									<?php elseif($keyword->form_type == 'form_pg'): ?>
									...
									<?php elseif($keyword->form_type == 'form_doctor'): ?>

										<link
											href="<?php echo e(asset('vendor/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css')); ?>"
											rel="stylesheet">
									...
									<?php elseif($keyword->form_type == 'form_serv'): ?>
							...
							<div class="erbr">
								...
								<select name="age" class="select2_age">
									...
									<?php for($i = 1; $i < 100; $i += 2): ?>
										<option value="<?php echo e($i); ?>" <?php echo e($i == 19 ? 'selected' : ''); ?>><?php echo e($i); ?> + Age</option>
									<?php endfor; ?>
								</select>
							</div>
							<div class="erbr">
							...
							<div class="erbr">
								...
								<select name="experience">
									...
									<?php for($i = 1; $i < 50; $i += 2): ?>
										<option value="<?php echo e($i); ?>" <?php echo e($i == 3 ? 'selected' : ''); ?>><?php echo e($i); ?> + Exp</option>
									<?php endfor; ?>
								</select>
							</div>
						...
						<div class="popup-step">
							...
							<div class="terms">
								...
								I agree to the Quickdials terms and conditions <a href="<?php echo e(url('terms-conditions')); ?>">Terms
									& Conditions</a>
							</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/quickdials/public_html/resources/views/client/searchlist.blade.php ENDPATH**/ ?>