...
<priority>0.80</priority>
 ...
 <?php $__currentLoopData = $keywords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <url>
        <loc><?php echo e(url('/')); ?>/<?php echo generate_slug($keyword->keyword) ?></loc>
        <lastmod><?php  
...
</urlset><?php /**PATH /home/quickdials/public_html/resources/views/client/sitemap.blade.php ENDPATH**/ ?>