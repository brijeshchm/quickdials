...
<?php $__env->startSection('content'); ?>
			...
			<div class="removeLeftSpace">
				<div class="hdTitle">
					...
					<div class="keyword-cotegory-text">
						...
						<?php if(!empty($keyword)): ?>
										<a href="<?php echo e(url('child/' . $keyword->child_slug)); ?>"
					...
					<div class="col-sm-12 col-md-12 reviews-box-1 line-content">
						...
						foreach ($assignedKwds as $assignedKwd) {
								...
								<div class="serchlist-txt-btn"><a href="javascript:void(0);" title="<?php echo e($client->business_name); ?>"
										...
										href="javascript:void(0);" title="<?php echo e($client->business_name); ?>"
						...
						if ($client->comment_count > 0) {
							...
							<div class="col-sm-12 col-md-12" style="padding-left:0;">
								<div class="clickBlick"><a href="<?php echo e(url('business-details') . '/' . $client->business_slug . ''); ?>"
				...
				<div class="category-box">
					<div class="course-program">
						...
						<ul class="">
							...
							<?php if(!empty($kwdsList)): ?>
								<?php $__currentLoopData = $kwdsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keywords): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<li class="">
										...
										} ?>" class="keystore"><?php echo e($keywords->keyword); ?></a>
									</li>
						...
						<ul class="row">
							...
							<?php if(!empty($cities)): ?>
								<?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<li class="col-sm-3 col-md-3"><a href="<?php echo e(url(strtolower($city->city))); ?>/<?php if (!empty($keyword->keyword)) {
										echo generate_slug($keyword->keyword);
									} ?>" title="<?php if (!empty($keyword->keyword)) {
										echo $keyword->keyword;
									} ?> in <?php echo e($city->city); ?>"><?php if(!empty($keyword->keyword)): ?><?php echo $keyword->keyword; ?><?php endif; ?>
												in <?php echo e($city->city); ?></a></li>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php endif; ?>
						</ul>
					</div>
	...
	<div class="bestDealpopup">
		...
		<div class="jbt"> Fill this form and get best deals from "<span
				class="orng"><?php if(!empty($keyword->keyword)): ?><?php echo $keyword->keyword; ?><?php endif; ?></span>"</div>
		<div class="bdc">
				...
				<aside>
					...
					<p><label for="yn">Your Name <span>*</span></label>
						...
						<input type="hidden" name="kw_text"
							value="<?php if(!empty($keyword->keyword)): ?><?php echo $keyword->keyword; ?><?php endif; ?>" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/quickdials/public_html/resources/views/client/searchkeyword.blade.php ENDPATH**/ ?>